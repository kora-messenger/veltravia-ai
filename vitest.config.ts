...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@veltravia/file-intelligence-core': r('./file-intelligence/core/src/index.ts'),
      '@veltravia/file-intelligence-mock': r('./file-intelligence/mock/src/index.ts'),
